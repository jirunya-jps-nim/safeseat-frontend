  ...
  return (
    <div className="selection-purple min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-inter relative overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-44 pb-24 flex flex-col gap-20">
        ...
        {/* Section 2: Core Values Bento */}
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 bg-[var(--color-card)] border border-[var(--color-border)] rounded-2xl shadow-xl flex flex-col gap-4 hover:border-[#2340A7]/50 transition-all">
        ...
        {/* Section 3: Why SafeSeat */}
        <section className="flex flex-col gap-10">
          <div className="text-center">
            <span className="text-xs font-bold tracking-[0.2em] text-[#2340A7] uppercase">ทำไมต้องเลือก SAFESEAT</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-[var(--color-card)] border border-[var(--color-border)] rounded-2xl flex items-start gap-4 shadow-md">
              <div className="p-3 bg-[#2340A7]/10 border border-[#2340A7]/30 rounded-xl text-[#2340A7] shrink-0">
            ...
            <div className="p-6 bg-[var(--color-card)] border border-[var(--color-border)] rounded-2xl flex items-start gap-4 shadow-md">
              ...
              <div>
                <h3 className="text-lg font-bold font-manrope text-[var(--color-text)] mb-2">เครือข่ายพาร์ทเนอร์สถานบันเทิง</h3>
                <p className="text-xs text-[var(--color-text-muted)] leading-relaxed">
                  สถานบันเทิง และร้านอาหาร สามารถเรียกรถ ส่งงาน และตรวจสอบสถิติเรียลไทม์เพื่อดูแลสวัสดิภาพผู้ใช้บริการหน้าสถานบันเทิงได้อย่างไร้รอยต่อ
                </p>
              </div>
            </div>
        ...
        <section className="p-12 bg-gradient-to-r from-[#2340A7] via-[#1D358F] to-[#2563EB] rounded-3xl text-center text-white shadow-2xl flex flex-col items-center gap-6">
          ...
          <button
            ...
            className="px-8 py-3.5 bg-white text-[#2340A7] font-bold text-xs tracking-wider uppercase rounded-full hover:bg-slate-100 transition-all shadow-lg cursor-pointer flex items-center gap-2"
          >
