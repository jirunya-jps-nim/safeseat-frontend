...
const styles: Record<string, React.CSSProperties> = {
  ...
  sliderContainer: {
    width: '100%',
    height: '360px', // เพิ่มความสูงตามผู้ใช้ต้องการ
    backgroundColor: '#0b0f19', // สีเข้มเสมอกันทุกสไลด์เพื่อความเป็นระเบียบและLegible
    display: 'flex',
    alignItems: 'center',
  ...
  imageGradientOverlay: {
    ...
    width: '100%',
    height: '100%',
    background: 'linear-gradient(90deg, #0b0f19 0%, rgba(11, 15, 25, 0.4) 50%, rgba(11, 15, 25, 0) 100%)',
    zIndex: 2,
  },
  slideImage: {
    width: '100%',
